...
{
    class ShieldItemBackwardPlayerState : IPlayerState
    {
        ...
        public ShieldItemBackwardPlayerState(IPlayer player, IProjectileController projectiles)
        {
            _player = player;
            _direction = Direction.Up;
            _velocity = new Vector2(0, -PlayerConstants.LinkVelocity);
            _player.LinkFrame = PlayerConstants.LinkUseItemBackRectangle;
