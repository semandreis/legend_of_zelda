...
{
    class ShieldNormalBackwardPlayerState : IPlayerState
    {
        ...
        public ShieldNormalBackwardPlayerState(IPlayer player, IProjectileController projectiles)
        {
            _player = player;
            _direction = Direction.Up;
            _velocity = new Vector2(0, -PlayerConstants.LinkVelocity);
            _playerFrame = PlayerConstants.PlayerNormalFramesBack;
