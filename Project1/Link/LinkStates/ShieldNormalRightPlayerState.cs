...
{
    class ShieldNormalRightPlayerState : IPlayerState
    {
        ...
        public ShieldNormalRightPlayerState(IPlayer player, IProjectileController projectiles)
        {
            _player = player;
            _direction = Direction.Right;
            _velocity = new Vector2(PlayerConstants.LinkVelocity, 0);
            _playerFrame = PlayerConstants.PlayerShieldFramesSide;
