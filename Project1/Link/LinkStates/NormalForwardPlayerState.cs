...
{
    class NormalForwardPlayerState : IPlayerState
    {
        ...
        public NormalForwardPlayerState(IPlayer player, IProjectileController projectiles)
        {
            _player = player;
            _direction = Direction.Down;
            _velocity = new Vector2(0, PlayerConstants.LinkVelocity);
            _playerFrame = PlayerConstants.PlayerNormalFramesFront;
