...
{
    class WhiteSwordObject : IGameObject
    {
        ...
        public WhiteSwordObject(Texture2D texture, Vector2 position, Direction direction)
        {
            ...
            _sprite = new WhiteSwordSprite(texture, direction);
            Exists = true;
            SetRectangle();
