...
namespace Zelda.Projectiles
{
    class ArrowObject : IGameObject
    {
        ...
        public ArrowObject(Texture2D texture, Vector2 position, Direction direction)
        {
            ...
            _sprite = new ArrowSprite(texture, direction, _lifespan);
            Exists = true;
            SetRectangle();
