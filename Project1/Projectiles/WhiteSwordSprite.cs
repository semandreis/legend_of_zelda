...
{
    class WhiteSwordSprite : Interfaces.IDrawable
    {
        public Rectangle SourceRectangle { get; set; }
        private readonly Texture2D _texture;
        private readonly Rectangle[] _sourceRectangles =
            { ProjectileConstants.WhiteSwordBeamFront, ProjectileConstants.WhiteSwordBeamSide };
        private static SpriteEffects _effects;

        public WhiteSwordSprite(Texture2D texture, Direction direction)
        {
            _texture = texture;
