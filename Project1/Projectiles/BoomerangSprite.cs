...
{
    class BoomerangSprite : Interfaces.IDrawable
    {
        public Rectangle SourceRectangle { get; set; }
        private readonly Texture2D _texture;
        private readonly Rectangle[] _sourceRectangles =
            { ProjectileConstants.Boomerang1, ProjectileConstants.Boomerang2, ProjectileConstants.Boomerang3,ProjectileConstants.BoomerangBoom};
        private static SpriteEffects _effects;
        private float _angle = 0;

        public BoomerangSprite(Texture2D texture, Direction direction)
        {
            _texture = texture;
