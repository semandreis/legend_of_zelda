...
{
    class WoodenSwordSprite : Interfaces.IDrawable
    {
        public Rectangle SourceRectangle { get; set; }
        private readonly Texture2D _texture;
        private readonly Rectangle[] _sourceRectangles =
            { ProjectileConstants.WoodSwordBeamFront, ProjectileConstants.WoodSwordBeamSide };
        private static SpriteEffects _effects;

        public WoodenSwordSprite(Texture2D texture, Direction direction)
        {
            _texture = texture;
