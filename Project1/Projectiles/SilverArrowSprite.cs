...
{
    class SilverArrowSprite : Interfaces.IDrawable
    {
        public Rectangle SourceRectangle { get; set; }
        private readonly Texture2D _texture;
        private readonly Rectangle[] _sourceRectangles =
            { ProjectileConstants.SilverArrowFront, ProjectileConstants.SilverArrowSide, ProjectileConstants.ArrowBoom };
        ...
        public SilverArrowSprite(Texture2D texture, Direction direction, float lifespan)
        {
            _texture = texture;
            _lifespan = lifespan;
