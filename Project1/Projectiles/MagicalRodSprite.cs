...
{
    class MagicalRodSprite : Interfaces.IDrawable
    {
        public Rectangle SourceRectangle { get; set; }
        private readonly Texture2D _texture;
        private readonly Rectangle[] _sourceRectangles =
            { ProjectileConstants.MagicalRodBeamFront, ProjectileConstants.MagicalRodBeamSide };
        private static SpriteEffects _effects;

        public MagicalRodSprite(Texture2D texture, Direction direction)
        {
            _texture = texture;
